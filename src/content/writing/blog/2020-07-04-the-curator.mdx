---
title: Can Word2Vec Describe Art-Historical Categories?
date: 2020-07-04
tags: word2vec, quackery, the-curator, art
---
...
<Caption>(Update: See footnote 2 for how this is an oversimplification of how the context window proceeds.)</Caption>
...
2. Update: This is an extreme simplification of how the context window proceeds. It actually iterates across a sentence word by word.
...
to       --> ['be', 'or', 'not']
be       --> ['to', 'or', 'not', 'that']
or       --> ['to', 'be', 'not', 'that', 'is']
not      --> ['to', 'be', 'or', 'that', 'is', 'the']
that     --> ['be', 'or', 'not', 'is', 'the', 'question']
is       --> ['or', 'not', 'that', 'the', 'question']
the      --> ['not', 'that', 'is', 'question']
