...
If we were to slide a context window across Shakespeare's ten famous words, they would be split into two groups of five words each:
...
<Caption>(<em>Not exactly iambicpentameter!</em>)</Caption>
