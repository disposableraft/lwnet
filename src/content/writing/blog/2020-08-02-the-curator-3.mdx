---
title: "Calculating Error Rates: The Curator"
date: 2020-08-02
tags: word2vec, graphs, error-rates
---
...
When trained on an English corpus a Word2Vec model can be tested using similies from WordNet. It's possible to test for syntactic similarity ("read is to reading as walk is to walking") and symantic similarity ("Berlin is to Germany as Paris is to France").
